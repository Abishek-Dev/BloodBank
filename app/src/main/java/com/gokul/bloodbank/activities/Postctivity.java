...
public class Postctivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_postctivity);
        ...
        if(cur_user == null)
        {
            startActivity(new Intent(Postctivity.this, LoginActivity.class));
                        ...
                        findname.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                if (dataSnapshot.exists()) {
                                    ...
                                    Toast.makeText(Postctivity.this, "Your post has been created successfully",
                                            Toast.LENGTH_LONG).show();
                                    startActivity(new Intent(Postctivity.this, Dashboard.class));
                                    overridePendingTransition(R.anim.entry,R.anim.exit);
